...
PBKDF2-HMAC-SHA256 and a random per-user salt, written to users.csv
next to this script (columns: username, salt, hash).

This is meant as a stopgap until SSO is wired up — swap it out once
that's approved (just delete users.csv and the login gate).
